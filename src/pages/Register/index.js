...
function Register() {
    return (
        ...
        >
            <div class="main">
                <Form>
                    <h2 class="firstTitle">Sign Up</h2>
                    <p class="firstSubTitle" id="subTitle">It's quick and easy.</p>
                    <hr />
                    ...
                    <p class="subTitle_2" id="subTitle">Date of Birth</p>
                    <select>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                    ...
                    <p class="subTitle_3" id="subTitle">Gender</p>
